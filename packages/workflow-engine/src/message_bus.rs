//! Legacy in-process message bus using `tokio::sync::broadcast` channels.
//!
//! Migrated from `apps/core/src/message_bus.rs` during architecture
//! migration (WP 10.4). New code should use the `EventBus` from this
//! crate's `event_bus` module.

use life_engine_traits::legacy_storage::Record;
