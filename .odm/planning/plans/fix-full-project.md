...
- [x] Harden auth middleware and token validation
...
- [x] Fix auth route WebAuthn and passkey issues
...
- [x] Harden config validation and secret handling
...
- [x] Fix storage migration count verification
...
- [x] Fix household access check and federation store issues
...
- [x] Fix identity signature verification determinism
  <!-- file: apps/core/src/identity.rs -->
...
- [x] Fix conflict merge O(n^2) key collection
  <!-- file: apps/core/src/conflict.rs -->
...
- [x] Add Connector trait lifecycle tests
...
- [x] Fix WASM runtime HTTP handling and security
  <!-- file: apps/core/src/wasm_runtime.rs -->
...
- [x] Fix search indexing and query issues
...
- [x] Fix federated create ID preservation
...
- [x] Reduce wasm_adapter code duplication
...
- [x] Fix dav-utils parsing and escaping bugs
...
- [x] Redact credentials in plugin SDK Debug output
...
- [x] Fix credential type date validation
...
- [x] Fix test utility SMTP parsing
...
- [x] Stream file content for SHA-256 computation
...
- [x] Sanitize error responses and strengthen passphrase requirements
...
- [x] Replace expect() panics in route handlers
...
- [x] Replace brittle string matching with typed errors
...
- [x] Fix federation route validation and testing
  <!-- file: apps/core/src/routes/federation.rs -->
...
- [x] Fix GraphQL performance and security issues
  <!-- file: apps/core/src/routes/graphql.rs -->
...
- [x] Fix data route user_id injection
...
- [x] Add household route integration tests
  <!-- file: apps/core/src/routes/household.rs -->
...
- [x] Fix connector route mutex holding during IO
...
- [x] Harden backup plugin backends
...
- [x] Fix backup engine manifest and schedule issues
...
- [x] Register PROPFIND/REPORT routes in CalDAV/CardDAV plugins
...
- [x] Fix CI check test flag and schema test
...
- [x] Fix deploy compose configuration issues
...
- [x] Fix Dockerfile HEALTHCHECK and dependency caching
  <!-- file: apps/core/Dockerfile -->
...
- [x] Fix OpenAPI spec validation gaps
...
- [x] Fix install script and scaffold script issues
